const AV_COURSES = [
  ...
  },
  {
    ...
    playlistUrl: 'https://www.youtube.com/@abhishekvermaa10/playlists',
    repositoryUrl: 'https://github.com/abhishekvermaa10?tab=repositories&q=microservices',
    vibes: ['Spring Cloud', 
      'Architecture', 
      'Ops'],
    keyTakeaways: [
    ...
    resources: [
      { label: 'Learn by watching', url: 'https://www.youtube.com/@abhishekvermaa10/playlists', type: 'video' },
      { label: 'Learn by coding', url: 'https://github.com/abhishekvermaa10?tab=repositories&q=microservices', type: 'code' },
    ],
    tags: ['Spring Cloud', 
      'Ops'],
    status: 'Upcoming',
